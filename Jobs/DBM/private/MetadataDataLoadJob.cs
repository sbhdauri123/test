...
namespace Greenhouse.Jobs.DBM.Metadata.Private
{
    [Export("DBM-PrivateMetadataDataLoad", typeof(IDragoJob))]
    public class DataLoadJob : Framework.BaseFrameworkJob, IDragoJob
    {
        ...
        public void Execute()
        {
            ...
            etl.LoadDBMPrivateMetadata(queueItem.FileGUID, path, base.SourceId, base.IntegrationId, CurrentIntegration.CountryID, queueItem.FileCollection.ToList());
